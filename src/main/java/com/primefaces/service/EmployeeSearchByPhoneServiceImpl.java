 ...
 * @author anonymous
 */
public class EmployeeSearchByPhoneServiceImpl implements EmployeeSearchService {

    @Override
    public List<Employee> search(String keyword) {
        keyword = SqlUtils.wrapKeywordLike(keyword);
        
        return QueryBuilder.fromSQL("SELECT * FROM Employees WHERE LOWER(phone_number) LIKE ?")
                .addParam(keyword)
